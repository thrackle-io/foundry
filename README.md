...
Each weekly nightly-build release from Foundry is given an incrementing minor version.

This repository contains modifications to `foundryup` made by [Thrackle](https://thrackle.io), to provide numeric versioned releases.
